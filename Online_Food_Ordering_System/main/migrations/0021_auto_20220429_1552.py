...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='item',
            name='labels',
            field=models.CharField(blank=True, choices=[('Best Selling Foods', 'Best Selling Foods'), ('New Food', 'New Food'), ('Spicy Foods🔥', 'Spicy Foods🔥'),('Drinks','Drinks'),('Breakfast', 'Breakfast')], max_length=25),
        ),
        migrations.AlterField(
            model_name='item',
            name='slug',
